...
<header class="header" style="background-color: #2c5f2c;">
  ...
  <div class="container mt-5">
    <h3 class="mb-4 text-center">Productos en el Carrito</h3>
    <div id="carrito" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4"></div>

    <div class="row row-cols-1 row-cols-md-3 g-4 section-spacing">  <!-- Espaciado agregado entre cards -->
      <!-- Producto 1 -->
      <div class="col">
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Tipo: ornamental, poca agua y sol.</p>
    ...
    <div class="total-container">
      <h4>Total: <span class="text-success fw-bold" id="total">₡0</span></h4>
      <button class="btn btn-success" onclick="hacerPedido()">Hacer Pedido</button>
    </div>
  </div>
